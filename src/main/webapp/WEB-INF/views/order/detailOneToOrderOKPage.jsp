    ...
    <div class="container">
        ...
        <div class="order-items">
            ...
            <table>
                ...
                <tbody>
                    <c:forEach var="item" items="${selectDetailOneToOrderOK}">
                        <tr>
                            <td>${item.title}</td>
                            <td>${item.count} 개</td>
                            <fmt:formatNumber value="${item.price}" pattern="#,###" var="price"/>
                            <fmt:formatNumber value="${item.totalPrice}" pattern="#,###" var="totalPrice"/>
                            <td>${price} 원</td>
                            <td>${totalPrice} 원</td>
                        </tr>
                    </c:forEach>
        ...
        <div class="btn-container">
            <button class="btn-detail" type="button" onclick="location.href='/orderDetailPage?orderId=${orderIds}'">📄 주문 상세보기</button>
            <button class="btn-shopping" type="button" onclick="location.href='/shopping'">🛍️ 쇼핑 계속하기</button>
        </div>
    </div>
