...
<div
	...
	<ul class="space-y-2">
		...
		<li class="pl-4"><a onclick="location.href='/QnaCSList2'" class="text-gray-600 hover:text-orange-500" style="cursor: pointer">농장 문의</a></li>
		</c:if>
		<c:if test="${sessionScope.userType == 2}">
		<li class="pl-4"><a onclick="location.href='/QnaCSList2'" class="text-gray-600 hover:text-orange-500" style="cursor: pointer">내 고객 문의</a></li>
		</c:if>
	</ul>
</div>
