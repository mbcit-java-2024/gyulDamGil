...
<html>    
    ...
    <title>제주귤마을</title>
    <script src="./제주귤마을_files/saved_resource"></script>
    <script>
        ...
        function showSection(sectionId) {
            ...
            document.getElementById('tab-' + sectionId.split('-')[1]).classList.add('text-orange-500', 'border-orange-500');
            document.getElementById('tab-' + sectionId.split('-')[1]).classList.remove('text-gray-500', 'border-transparent');
        }
    ...
    <div class="min-h-screen">
        ...
        <div class="bg-orange-500 text-white text-sm py-1">
            <div class="container mx-auto px-4 text-center">
                <a href="file:///C:/Users/hi/Documents/%EC%B9%B4%EC%B9%B4%EC%98%A4%ED%86%A1%20%EB%B0%9B%EC%9D%80%20%ED%8C%8C%EC%9D%BC/%EC%A0%9C%EC%A3%BC%20%EA%B7%A4%20%EC%A7%81%EA%B1%B0%EB%9E%98%20%ED%8E%98%EC%9D%B4%EC%A7%80.html#" class="hover:underline">판매자 입점 신청하기 →</a>
            </div>
        </div>
            ...
            <div class="container mx-auto px-4">
                ...
                <div class="flex items-center justify-between py-2 border-b">
                    <div class="flex items-center">
                        ...
                        <h1 class="text-2xl font-bold text-orange-500"><a href="/">귤담길</a></h1>
                    </div>
                    
                    <div class="flex items-center space-x-4">
                        <div class="relative hidden md:block">
                            <input type="text" placeholder="상품 또는 농가를 검색하세요" class="w-64 px-4 py-1 border rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-orange-500">
                        ...
                        <div class="flex items-center space-x-3">
                            <button onclick="toggleUserMenu()" class="text-sm hover:text-orange-500">
                ...
                <nav class="hidden md:block py-3">
                    <ul class="flex items-center space-x-8">
                        <li>
                            <button id="tab-home" onclick="showSection(&#39;section-home&#39;)" class="px-4 py-2 font-medium border-b-2 border-orange-500 text-orange-500">
                                홈
                            </button>
                        </li>
                        <li>
                            <button id="tab-about" onclick="showSection(&#39;section-about&#39;)" class="px-4 py-2 font-medium border-b-2 border-transparent text-gray-500 hover:text-orange-500">
                                브랜드 소개
                            </button>
                        </li>
                        <li>
                            <button id="tab-shop" onclick="location.href='/jejugamgyulList/0'" class="px-4 py-2 font-medium border-b-2 border-transparent text-gray-500 hover:text-orange-500">
                                쇼핑
                            </button>
                        </li>
                        <li>
                            <button id="tab-reservation" onclick="showSection(&#39;section-reservation&#39;)" class="px-4 py-2 font-medium border-b-2 border-transparent text-gray-500 hover:text-orange-500">
                                체험예약
                            </button>
                        </li>
                        <li>
                            <button id="tab-farms" onclick="showSection(&#39;section-farms&#39;)" class="px-4 py-2 font-medium border-b-2 border-transparent text-gray-500 hover:text-orange-500">
                                입점 농가
                            </button>
                        </li>
					...
					<c:if test="${sessionScope.userType == 1}">
               			<li>
               				<button id="tab-orderList" onclick="location.href='myOrder'" class="px-4 py-2 font-medium border-b-2 border-transparent text-gray-500 hover:text-orange-500">
               					주문목록
               				</button>
               			</li>
					</c:if>
					<c:if test="${sessionScope.userType == 2}">
						<li>
                            <button id="tab-myProduct" onclick="location.href='sellerList'" class="px-4 py-2 font-medium border-b-2 border-transparent text-gray-500 hover:text-orange-500">
	               				내 상품보기
                            </button>
               			</li>
						<li>
                        	<button id="tab-insertProduct" onclick="location.href='insert'" class="px-4 py-2 font-medium border-b-2 border-transparent text-gray-500 hover:text-orange-500">
	               				상품등록
                        	</button>
               			</li>
               			<li>
               				<button id="tab-orderList" onclick="location.href='orderList'" class="px-4 py-2 font-medium border-b-2 border-transparent text-gray-500 hover:text-orange-500">
               					주문목록
               				</button>
               			</li>
					</c:if>
        ...
        <div id="mobile-menu" class="md:hidden hidden bg-white border-b">
            <nav class="container mx-auto px-4 py-4">
                <ul class="space-y-4">
                    <li><a href="file:///C:/Users/hi/Documents/%EC%B9%B4%EC%B9%B4%EC%98%A4%ED%86%A1%20%EB%B0%9B%EC%9D%80%20%ED%8C%8C%EC%9D%BC/%EC%A0%9C%EC%A3%BC%20%EA%B7%A4%20%EC%A7%81%EA%B1%B0%EB%9E%98%20%ED%8E%98%EC%9D%B4%EC%A7%80.html#" onclick="showSection(&#39;section-home&#39;)" class="block hover:text-orange-500">홈</a></li>
                    <li><a href="file:///C:/Users/hi/Documents/%EC%B9%B4%EC%B9%B4%EC%98%A4%ED%86%A1%20%EB%B0%9B%EC%9D%80%20%ED%8C%8C%EC%9D%BC/%EC%A0%9C%EC%A3%BC%20%EA%B7%A4%20%EC%A7%81%EA%B1%B0%EB%9E%98%20%ED%8E%98%EC%9D%B4%EC%A7%80.html#" onclick="showSection(&#39;section-about&#39;)" class="block hover:text-orange-500">브랜드 소개</a></li>
                    <li><a href="file:///C:/Users/hi/Documents/%EC%B9%B4%EC%B9%B4%EC%98%A4%ED%86%A1%20%EB%B0%9B%EC%9D%80%20%ED%8C%8C%EC%9D%BC/%EC%A0%9C%EC%A3%BC%20%EA%B7%A4%20%EC%A7%81%EA%B1%B0%EB%9E%98%20%ED%8E%98%EC%9D%B4%EC%A7%80.html#" onclick="showSection(&#39;section-shop&#39;)" class="block hover:text-orange-500">쇼핑</a></li>
                    <li><a href="file:///C:/Users/hi/Documents/%EC%B9%B4%EC%B9%B4%EC%98%A4%ED%86%A1%20%EB%B0%9B%EC%9D%80%20%ED%8C%8C%EC%9D%BC/%EC%A0%9C%EC%A3%BC%20%EA%B7%A4%20%EC%A7%81%EA%B1%B0%EB%9E%98%20%ED%8E%98%EC%9D%B4%EC%A7%80.html#" onclick="showSection(&#39;section-reservation&#39;)" class="block hover:text-orange-500">체험예약</a></li>
                    <li><a href="file:///C:/Users/hi/Documents/%EC%B9%B4%EC%B9%B4%EC%98%A4%ED%86%A1%20%EB%B0%9B%EC%9D%80%20%ED%8C%8C%EC%9D%BC/%EC%A0%9C%EC%A3%BC%20%EA%B7%A4%20%EC%A7%81%EA%B1%B0%EB%9E%98%20%ED%8E%98%EC%9D%B4%EC%A7%80.html#" onclick="showSection(&#39;section-farms&#39;)" class="block hover:text-orange-500">입점 농가</a></li>
                </ul>
            </nav>
        </div>
        ...
        <div id="section-home" class="container mx-auto px-4 py-8">
            ...
            <section class="bg-orange-100 rounded-xl p-8 mb-8">
                <h2 class="text-4xl font-bold mb-4">제주 농가와 함께하는<br>신선한 귤 직거래</h2>
        ...
        <!-- Shop Section -->
        <div id="section-shop" class="hidden container mx-auto px-4 py-8">
            <div class="flex flex-col md:flex-row gap-8">
                <!-- Categories Sidebar -->
                <div class="w-full md:w-64 bg-white rounded-lg shadow-md p-4">
                    <h3 class="font-semibold mb-4">카테고리</h3>
                    <ul class="space-y-2">
                        <li class="font-medium" onclick="location.href='/jejugamgyulList/1'">과일</li>
                        <li class="font-medium" onclick="location.href='/jejugamgyulList/4'">쥬스</li>
                        <li class="font-medium" onclick="location.href='/jejugamgyulList/5'">잼</li>
                        <li class="font-medium" onclick="location.href='/jejugamgyulList/6'">기타</li>
                        <!-- <li class="font-medium">과일</li>
                        <li class="pl-4"><a href="javascript:void(0);" value="0" onclick="location.href='/jejugamgyulList?categoryId=0'" class="text-gray-600 hover:text-orange-500">제주감귤</a></li>
                        <li class="pl-4"><a href="javascript:void(1);" value="1" onclick="location.href='/jejugamgyulList?categoryId=1'" class="text-gray-600 hover:text-orange-500">온주밀감</a></li>
                        <li class="pl-4"><a href="javascript:void(0);" value="2" onclick="location.href='/jejugamgyulList?categoryId=2'" class="text-gray-600 hover:text-orange-500">한라봉</a></li>
                        <li class="pl-4"><a href="javascript:void(0);" value="3" onclick="location.href='/jejugamgyulList?categoryId=3'" class="text-gray-600 hover:text-orange-500">천혜향</a></li>
                        <li class="pl-4"><a href="javascript:void(0);" value="4" onclick="location.href='/jejugamgyulList?categoryId=4'" class="text-gray-600 hover:text-orange-500">레드향</a></li>
                        <li class="pl-4"><a href="javascript:void(0);" value="5" onclick="location.href='/jejugamgyulList?categoryId=5'" class="text-gray-600 hover:text-orange-500">청견</a></li>
                        <li class="pl-4"><a href="javascript:void(0);" value="6" onclick="location.href='/jejugamgyulList?categoryId=6'" class="text-gray-600 hover:text-orange-500">황금향</a></li>
                        <li class="pl-4"><a href="javascript:void(0);" value="7" onclick="location.href='/jejugamgyulList?categoryId=7'" class="text-gray-600 hover:text-orange-500">카라향</a></li>
                        <li class="pl-4"><a href="javascript:void(0);" value="8" onclick="location.href='/jejugamgyulList?categoryId=8'" class="text-gray-600 hover:text-orange-500">진지향</a></li>
                        <li class="pl-4"><a href="javascript:void(0);" value="9" onclick="location.href='/jejugamgyulList?categoryId=9'" class="text-gray-600 hover:text-orange-500">세토카</a></li> -->
                    </ul>
                </div>
        ...
        <div id="section-reservation" class="hidden container mx-auto px-4 py-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <button onclick="location.href='gyulexperienceList'" class="w-full bg-orange-500 text-white py-2 rounded-lg hover:bg-orange-600">
                        예약하기
                    </button>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <button class="text-orange-500 hover:text-orange-600">자세히 보기 →</button>
                        </div>
                    </div>
                </div>
                <!-- More farm cards... -->
            ...
            <div class="container mx-auto px-4">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2">
                            <li class="hover:text-orange-300 cursor-pointer">농장주 입점</li>
                            <li class="hover:text-orange-300 cursor-pointer">제휴문의</li>
                        </ul>
                    </div>
                    <div>
                        <h5 class="font-bold mb-4">SNS</h5>
                        <div class="flex space-x-4">
                            <span class="hover:text-orange-300 cursor-pointer">Instagram</span>
                            <span class="hover:text-orange-300 cursor-pointer">Facebook</span>
                        </div>
                    </div>
                </div>
            </div>
