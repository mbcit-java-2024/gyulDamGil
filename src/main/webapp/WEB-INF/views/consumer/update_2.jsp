...
<c:if test="${not empty sessionScope.userVO}">
	...
	<form action="/updateOK_/1" method="post" onsubmit="confirmCheck(1)" class="d-flex flex-column align-items-center">
	...
	<div class="table-container center"  style="width: 600px;">
		...
		<input type="submit" class="btn mb-2 mt-2 btn-lg" value="수정하기"
			style="background-color: #F89D00; width: 300px; color: white;" onclick="agreeCheck(1)"/>
