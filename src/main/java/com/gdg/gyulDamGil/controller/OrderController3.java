...
public class OrderController3 {
	...
	public Map<String, Object> addToOrder(@RequestBody Map<String, Object> param) {// throws Exception {
...
//		System.out.println("OrderController =========3=========addToOrder::::totalPrice===" + orderVo.getTotalPrice());
	...
	public Map<String, Object> orderOKToOne(@RequestBody Map<String, Object> param) {// throws Exception {
